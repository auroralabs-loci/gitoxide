...
fn hour_minute_with_colon_timezone() {
    assert_eq!(
        gix_date::parse("20080214T2030-04:00", None).unwrap(),
        Time {
            seconds: 1203035400,
            offset: -14400,
        },
...
fn hour_minute_with_compact_timezone() {
    assert_eq!(
        gix_date::parse("20080214T2030-0400", None).unwrap(),
        Time {
            seconds: 1203035400,
            offset: -14400,
        },
...
fn hour_minute_with_positive_timezone() {
    assert_eq!(
        gix_date::parse("20080214T2030+05:30", None).unwrap(),
        Time {
            seconds: 1203001200,
            offset: 19800,
        },
...
fn hour_only_with_timezone() {
    assert_eq!(
        gix_date::parse("20080214T20-0400", None).unwrap(),
        Time {
            seconds: 1203033600,
            offset: -14400,
        },
